...
const AuthorsPage = () => {
    ...
    if (status === "loading") return (<div className="p-4 font-bold"><span className="text-purple-200">L</span>
    ...
    return (
        <div className="">
            <h1 className="mb-5 text-2xl text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-gray-600 font-bold">Bloging is So Fun!!!</h1>
                ...
                <div className={`${open ? "block" : 'hidden'} md:block`}>
                    <div className="flex items-center gap-3 px-4">
                        ...
                        /> : user?.imageUrl && <img
                            ...
                            h="40"
                        />}
                        <h1 className="font-serif text-4xl text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-700 font-bold">{allPosts[0]?.user.username || user?.username}</h1>
                    </div>
                    <div className="text-sm text-gray-500 mt-1 px-4 mb-1">
                        {isMyDashboard && isEditingBio ? (
                            ...
                            <p>
                                {allPosts[0]?.user?.bio || "To make your new bio visible, you need to publish at least one post. Your updated bio will appear on your profile as soon as your first blog is live!"}
                            </p>
                        )}
                    </div>
                    {isMyDashboard && (
